...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self): #创建Player对象时，自动调用，所有的Player对象都有__init__之中的属性
        ...
        self.current_weapon = WeaponType.PISTOL      # 当前武器类型
        # 射击系统 ------------------------------------------------------------
    ...
    def _handle_shooting(self, bullets): #处理射击
        ...
        if (mouse_pressed and
            ...
            bullets.add_bullet(self.rect.center, pygame.mouse.get_pos(), WeaponType.PISTOL) #使用了weapons.py里的add_bullet
            self.ammo -= 1
    ...
    def _fire_circular_bullets(self, bullets):
        ...
        for i in range(directions):
            ...
            bullets.add_bullet(self.rect.center, target_pos, WeaponType.PISTOL)
