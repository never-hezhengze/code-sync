...
LEVELS = {
    ...
    6: {"name": "Advanced Combat", "enemy_types": ["normal", "fast", "tank"], "spawn_rate": 18, "max_enemies": 12},
    7: {"name": "Tactical Challenge", "enemy_types": ["normal", "fast", "tank"], "spawn_rate": 15, "max_enemies": 14},
    8: {"name": "Elite Forces", "enemy_types": ["fast", "tank"], "spawn_rate": 12, "max_enemies": 16},
    9: {"name": "Final Challenge", "enemy_types": ["normal", "fast", "tank"], "spawn_rate": 10, "max_enemies": 12},
    10: {"name": "Endless Mode", "enemy_types": ["normal", "fast", "tank"], "spawn_rate": 8, "max_enemies": 20}
}
