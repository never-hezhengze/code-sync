...
class UI:
    ...
    def _prerender_static_text(self):
        ...
        self.static_text = {
            ...
            'weapon_names': {
                ...
                WeaponType.MACHINE_GUN: self.font_small.render("Weapon: MG", True, COLORS['ui_text']),
                WeaponType.CANNON: self.font_small.render("Weapon: Cannon", True, COLORS['ui_text'])
            },
    ...
    def draw_map_mechanics_info(self, screen, game_map, x, y):
        ...
        elif mechanics.get("type") == "power_grid":
            status_text = f"Power Grid: {'Online' if game_map.is_power_grid_active() else 'Offline'}"
            color = (100, 100, 255) if game_map.is_power_grid_active() else (255, 100, 100)
        else:
