...
def solve_one_truck_type(truck_name: str):
    ...
    while sum(remaining.values()) > 0:
        ...
        print(
            ...
            f"装入 {sum(plan.actual_counts.values())} 件（模块 {len(plan.placed_modules)} 个），"
...
def parse_args():
    ...
    parser.add_argument("--outdir", type=str, default="../结果展示/output1.2_final_best_combo_v2", help="输出目录")
