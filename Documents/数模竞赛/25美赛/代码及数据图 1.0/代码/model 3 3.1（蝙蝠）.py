...
def main():
    ...
    print(f"[No Bat] final yield = {nobat_yield:.2f}")
    ...
    ax1.plot(t_nobat, P1_nb, 'g--', label="Crop1(NoBat)")
    ax1.plot(t_nobat, P2_nb, 'b--', label="Crop2(NoBat)")
    ax1.plot(t_nobat, W_nb,  'y--', label="Weed(NoBat)")
    ...
    ax1.set_title("Producers & Weed: NoBat vs Best Intro")
    ax1.set_xlabel("Time")
    ...
    ax2.plot(t_nobat, C1_nb, 'c--', label="C1(NoBat)")
    ax2.plot(t_nobat, C2_nb, 'm--', label="C2(NoBat)")
    ax2.plot(t_nobat, C3_nb, 'r--', label="C3(NoBat)")
    ...
    ax3.plot(t_nobat, S1_nb, 'r--', label="S1(NoBat)")
    ax3.plot(t_nobat, S2_nb, 'k--', label="S2(NoBat)")
    ax3.plot(t_nobat, S3_nb, 'g--', label="S3(NoBat)")
    ...
    ax4.plot(t_nobat, T1_nb, 'm--', label="T1(NoBat)")
