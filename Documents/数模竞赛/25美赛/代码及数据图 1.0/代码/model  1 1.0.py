...
def model(y, t, r_P, K_P, alpha_P, r_I, K_I, beta_P, delta_I, gamma_I, r_C, K_C, eta_I, mu_C):
    ...
    dIdt = r_I * I * (1 - I / K_I) + beta_P * P - delta_I * I - gamma_I * I - eta_I * I * C

    # Birds/Bats population dynamics (Logistic growth, insect consumption)
    dCdt = r_C * C * (1 - C / K_C) + eta_I * I * C - mu_C * C
...
solution = odeint(model, y0, t, args=(r_P, K_P, alpha_P, r_I, K_I, beta_P, delta_I, gamma_I, r_C, K_C, eta_I, mu_C))
