...
def model(t, y):
    ...
    # 计算除草剂和杀虫剂浓度
    S_W = pesticide_concentration(t, peak_time=8, intensity=4000, duration=3)  # 除草剂
    S1_W =pesticide_concentration(t, peak_time=12, intensity=2000, duration=3) #除草剂2
    S2_W = pesticide_concentration(t, peak_time=16, intensity=1200, duration=3)  # 除草剂2
    ...
    dWdt = r_W * W * (1 - W / K_W) - alpha_W_C1 * W * C1 - alpha_W_C2 * W * C2 - gamma_W * S_W -gamma1_W * S1_W  - gamma2_W * S2_W -gamma3_W * S3_W - alpha_W_P1 * W * P1 - alpha_W_P2 * W * P2
