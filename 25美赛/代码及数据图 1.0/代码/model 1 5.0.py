...
alpha_P1_C2 = 0.00015  # 初级消费者2的影响import numpy as np
import matplotlib.pyplot as plt
from scipy.integrate import solve_ivp
...
alpha_W_P1 = 0.00001  # 生产者1对杂草的影响
alpha_W_P2 = 0.00001  # 生产者2对杂草的影响
...
def model(t, y):
    ...
    # 计算除草剂和杀虫剂浓度
    S_W = pesticide_concentration(t, peak_time=8, intensity=10000, duration=3)  # 除草剂
    S_C1 = pesticide_concentration(t, peak_time=15, intensity=10000, duration=30)  # 针对消费者1的杀虫剂
    S_C2 = pesticide_concentration(t, peak_time=15, intensity=10000, duration=30)  # 针对消费者2的杀虫剂
    S_C3 = pesticide_concentration(t, peak_time=15, intensity=10000, duration=30)  # 针对消费者3的杀虫剂
    # 生产者动态
...
# 时间范围
t = np.linspace(0, 20, 1000)  # 从0到200天，划分为1000个点
