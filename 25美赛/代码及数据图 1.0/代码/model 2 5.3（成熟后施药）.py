...
def model_extended(t, y):
    ...
    S_W  = pesticide_concentration(t, peak_time=8,  intensity=3500, duration=3)
    S1_W = pesticide_concentration(t, peak_time=12, intensity=3000, duration=3)  # 除草剂2
    S2_W = pesticide_concentration(t, peak_time=16, intensity=1000, duration=3)  # 除草剂2
    S3_W = pesticide_concentration(t, peak_time=20, intensity=1000, duration=3)  # 除草剂2
    S_C1 = pesticide_concentration(t, peak_time=15, intensity=8000, duration=30)
    S_C2 = pesticide_concentration(t, peak_time=15, intensity=8000, duration=30)
    S_C3 = pesticide_concentration(t, peak_time=15, intensity=8000, duration=30)
